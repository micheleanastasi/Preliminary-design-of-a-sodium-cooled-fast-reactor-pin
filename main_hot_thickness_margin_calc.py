...
plt.grid()
plt.savefig(os.path.join("saved_figures","maxFuelTemp_vs_thickness_0.png"),dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
plt.xlabel("Cladding thickness value in [mm]")
plt.grid()
plt.savefig(os.path.join("saved_figures","MarginFuelTempToMelt_0.png"),dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
plt.xlabel("Cladding thickness value in [mm]")
plt.grid()
plt.savefig(os.path.join("saved_figures","GapMin_vs_Thickness_0.png"),dpi=300, bbox_inches='tight')
plt.show()
plt.close()