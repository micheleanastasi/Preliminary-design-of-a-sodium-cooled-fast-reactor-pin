...
data_coldGeo_stepPower_power_tempZ = np.array([ xx,yy_power_linear,yy_temp_coolant, yy_temp_clad_out, yy_temp_clad_in, yy_temp_fuel_out, yy_temp_fuel_in,yy_htc_local,yy_adim_number_cool[0,:],yy_adim_number_cool[1,:],yy_adim_number_cool[2,:],yy_adim_number_cool[3,:],
